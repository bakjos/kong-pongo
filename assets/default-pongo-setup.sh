...
for rockspec in $(find /kong-plugin -maxdepth 1 -type f -name '*.rockspec'); do
  ...
  luarocks install --only-deps "$rockspec" --only-server https://raw.githubusercontent.com/rocks-moonscript-org/moonrocks-mirror/daab2726276e3282dc347b89a42a5107c3500567
done
